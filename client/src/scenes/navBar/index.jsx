...
const NavBar = ()=>{
    ...
    //useDispatcher to dispatch actions from the reducers
    const dispatch = useDispatch();
    
    const navigate= useNavigate();
    
    //useSelector is to grab information from the state
    ...
    return(
        //the box property is allowing as to pass css properties inside
